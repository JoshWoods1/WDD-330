...
function starshipTemplate(ship) {
  ...
  <p>Name:<span class="ship-name">${ship.name}</span></p>
  <p>Model:<span class="ship-model">${ship.model}</span></p>
  <p>Cost: <span class="ship-cost">${ship.cost_in_credits} days</span></p>
  <p>Length: <span class="ship-length">${ship.length} hrs</span></p>
  <p>Starship Class: <span class="ship-class">${ship.starship_class}</span></p>
  </li>`;
}
...
<section class="film__planets">
    <h3>Planets</h3>
    <ul class="film__planets-list"><img class="smallloader" src="planetloader.webp" /></ul>
  </section>
  <section class="film__starships">
    <h3>Starships</h3>
    <ul class="film__starships-list"><img class="smallloader" src="shiploader.gif" /></ul>
  </section>`;
}
